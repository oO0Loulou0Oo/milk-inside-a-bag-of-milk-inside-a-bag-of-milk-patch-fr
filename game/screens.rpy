...
screen lang_choice:
    textbutton "{font=basis33.ttf}Русский{/font}":
        text_size 50
        xalign 0.5
        yalign 0.33
        action [Language(None), Return()]
    textbutton "{font=basis33.ttf}English{/font}":
        text_size 50
        xalign 0.5
        yalign 0.38
        action [Language("english"), Return()]
    textbutton "{font=basis33.ttf}Portuguese{/font}":
        text_size 50
        xalign 0.5
        yalign 0.43
        action [Language("portuguese"), Return()]
    textbutton "{font=aaa.ttf}中文{/font}":
        text_size 50
        xalign 0.5
        yalign 0.505
        action [Language("chinese"), Return()]
    textbutton "{font=basis33.ttf}Spanish{/font}":
        text_size 50
        xalign 0.5
        yalign 0.555
        action [Language("spanish"), Return()]
    textbutton "{font=basis33.ttf}Polski{/font}":
        text_size 50
        xalign 0.5
        yalign 0.605
        action [Language("polski"), Return()]
    textbutton "{font=aaa.ttf}Türkçe{/font}":
        text_size 40
        xalign 0.5
        yalign 0.67
        action [Language("turkish"), Return()]    
    textbutton "{font=aaa.ttf}Français{/font}":
        text_size 40
        xalign 0.5
        yalign 0.72
